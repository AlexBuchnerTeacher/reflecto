...
class ReflectoSnackbar {
  static void showSaved(BuildContext context) {
    ...
    final snack = SnackBar(
      ...
      shape: theme.shape ?? RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
      backgroundColor: theme.backgroundColor ?? Theme.of(context).colorScheme.primary.withValues(alpha: 0.9),
    );
